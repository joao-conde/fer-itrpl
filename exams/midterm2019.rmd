...
#### JMBAG: 0036528317         
#### Name and surname: João Conde 
#### e-mail: joaodiasconde@gmail.com
#### IP address: 161.53.78.35
...
points <- read.csv("coursePoints.csv") #no strings so no need for 'stringsAsFactors = F'
str(points)
head(points)
```
...
**SOLUTION**
```{r}
dirtyIris <- read.csv("dirtyIris.csv")
str(dirtyIris)
head(dirtyIris)
cat("-----------------------------------------------------------------\n")
